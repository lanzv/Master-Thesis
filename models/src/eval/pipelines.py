...
def evaluation_pipeline(X_train, y_train, X_test, y_test, train_perplexity=-1, test_perplexity=-1, mawp_score=-1,
    ...
    print("\t\t\t average: {:.2f} tones in one segment".format(avg_segment_len))
    print()
    print("\t\t Melody Aligned With Words")
    print("\t\t\t words alignment: {:.2f}% of words".format(maww_words*100))
    print("\t\t\t segments alignment: {:.2f}% of segments".format(maww_segments*100))
    print("\t\t\t average alignment: {:.2f}% in average".format(maww_average*100))
    print()
    ...
    print("\t\t\t vls: {:.2f} vocab diversity".format(vocab_levenshtein))
    ...
    print("\t\t\t mawp: {:.2f}% of phrases".format(mawp_score*100))
    print()
    print("\t\t Melody Aligned With Words")
    print("\t\t\t words alignment: {:.2f}% of words".format(maww_words*100))
    print("\t\t\t segments alignment: {:.2f}% of segments".format(maww_segments*100))
